...
<template>
  ...
  <div class="relative min-h-[600px] mt-12">
    <picture>
      ...
      <img src="/background.svg" class="absolute w-full md:h-[80%] sm:h-[40%] z-[-1] md:object-cover" />
    </picture>
  ...
  <div class="flex justify-center mt-2">
    <a href="https://paypal.me/softcrystal1" target="_blank"
      class="flex items-center text-blue-700 hover:text-blue-900 active:text-blue-900">
    ...
    <form @submit.prevent="request">
      <div class="mb-4">
        ...
        <input type="text" id="name" name="name"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-green-600 dark:placeholder-gray-400"
          required>
      </div>
      <div class="mb-4">
      ...
      <button :disabled="sent" type="submit"
        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">送信</button>
    </form>
    <div role="alert"
